        ...
        <div className="container-xxl container-fluid">
            ...
            <div className="row">
                ...
                <div className="col-xl-9 col-lg-8 col-md-7 ps-md-25">
                    ...
                    <hr/>
                    <htmlForm action="./checkout.html" method="POST">
                        <div className="pt-md-50 pt-30">
                            <div className="">
                                <label htmlFor="ID" className="htmlForm-label text-lg fw-medium color-palette-1 mb-10">Verify
                                    ID</label>
                                    <br/>
                                <input type="text" className="htmlForm-control rounded-pill text-lg" id="ID" name="ID"
                        ...
                        <div className="pb-50">
                            <label htmlFor="bankAccount" className="htmlForm-label text-lg fw-medium color-palette-1 mb-10">Bank
                                Account
                                Name</label>
                                <br/>
                            <input type="text" className="htmlForm-control rounded-pill text-lg" id="bankAccount"
